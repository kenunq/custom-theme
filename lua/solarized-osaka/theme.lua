...
function M.setup()
  ...
  theme.highlights = {
    ...
    --- Keywords
    ["@keyword"] = { fg = "#89DDFF", style = options.styles.keywords }, -- For keywords that don't fall in previous categories.
    ["@keyword.function"] = { fg = "#89DDFF", style = options.styles.functions }, -- For keywords used to define a fuction.
