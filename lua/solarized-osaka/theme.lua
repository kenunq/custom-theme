...
function M.setup()
  ...
  theme.highlights = {
    ...
    Boolean       = { fg = "#C792EA" , italic = true }, --  a boolean constant: TRUE, false
    ...
    Type = { fg = "#FFCB6B" }, -- (preferred) int, long, char, etc.
    ...
    Debug = { fg = "#82AAFF" }, --    debugging statements
    ...
    ["@namespace.builtin"] = { link = "Function" },
    ["@none"] = {},
    ["@number"] = { link = "Number" },
    ...
    --- Functions
    ["@constructor"] = { fg = "#82AAFF" }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
